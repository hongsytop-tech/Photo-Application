...
# 안드로이드가 정한 **지름 72dp 원**입니다.
#
# 그 원에 딱 맞추면(0.98) 여백이 1.0 밖에 안 남습니다. 마스크 모양을 한 번
# 잘못 짚어 본 뒤라 딱 맞추지 않고 여유를 3.1 로 벌렸습니다. 캐릭터가 6%
# 작아지는 대신 어떤 런처에서도 연필 끝까지 온전히 나옵니다.
ZOOM = 0.92
...
# 카메라는 두 눈 아래, 가운데에서 살짝 왼쪽. 위쪽 모서리(cy - 반높이)가 눈
# 아래(38.5)보다 내려와야 두 눈이 다 보입니다.
CAM = (33.0, 49.6, 10.6, 9.6)     # cx, cy, 반너비, 반높이
